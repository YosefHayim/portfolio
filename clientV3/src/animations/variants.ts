...
const EASE_OUT_EXPO: Transition['ease'] = [EASE_EXPO_1, EASE_EXPO_2, EASE_EXPO_3, EASE_EXPO_2];
const EASE_OUT_BACK: Transition['ease'] = [EASE_BACK_1, EASE_BACK_2, EASE_BACK_3, EASE_EXPO_2];
